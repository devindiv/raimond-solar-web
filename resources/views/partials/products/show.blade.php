...
<section class="flex flex-col space-y-4 md:space-y-10">
    ...
    px-4 py-6 space-x-0 md:px-36 md:space-x-20">
        ...
        class="object-cover object-center drop-shadow-xl h-4/5 md:w-1/2 md:h-[45rem]">
        ...
        <table class="min-w-full leading-normal">
            ...
            <form action="" method="post" class="flex flex-col md:flex-row space-y-4 md:space-y-0 justify-between">
                @csrf
                <input type="text" class="border border-gray-200 rounded p-2 md:w-4/5" name="phone"
